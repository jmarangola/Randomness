...
\section*{2.}
    ...
    \begin{tikzpicture}
        \begin{axis}[
          ...
          \addplot [fill=cyan!20, draw=none, domain=6:6.75] {gauss(5,.55)}\closedcycle;
          \addplot [fill=red!10, draw=none, domain=5:6] {gauss(7,.55)} \closedcycle;
          \addplot [very thick,cyan!50!black] {gauss(5,.55)};
          \addplot [very thick,cyan!50!black] {gauss(7,.55)};
        \node at (420,25) {$\alpha$};
        \node at (385,25) {$\beta$};
        \end{axis}
